...
import org.hopen.core.SysPropertyPlaceholderConfigurer;
import org.hopen.utils.PropertiesUtils;
...
public class RSAEncrypt {
	...
	public String encrypt(RSAPublicKey publicKey, byte[] plainTextData) throws Exception{
		...
		try {
			...
			return encode.encodeBuffer(output);
		} catch (NoSuchAlgorithmException e) {
	 ...
	 */
	public byte[]  decrypt(RSAPrivateKey privateKey, String codeCipherData) throws Exception{
		if (privateKey== null){
		...
		try {
			...
			byte[] output= cipher.doFinal(decode.decodeBuffer(codeCipherData));
			return output;
		} catch (NoSuchAlgorithmException e) {
