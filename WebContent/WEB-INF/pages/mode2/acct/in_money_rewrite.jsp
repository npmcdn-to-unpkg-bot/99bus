...
<form action="usrbs/toCptl" id="subtoCptl" method="post"></form>
<!--[if lte IE 9]>
...
<![endif]-->
	<div style="width:100%;">
		<table style="margin:auto;margin-top:4px; width:100%;background:white;" class="border-c" >
			<Tr>
				...
				<td width="70%" style="padding:5px;text-align:right;color:#ccc;">${response.card_no}</td>
			</tr>
			<Tr style="border-top:1px dashed #ccc;">
				<td width="30%" height=50 style="padding:5px;">银行</td>
				<td width="70%" style="padding:5px;text-align:right;color:#ccc;">${response.bank_nm}</td>
				<input type="hidden" name="bank_cd" value="${response.bank_cd}" />
		...
		<table style="margin:auto;margin-top:20px; width:100%;background:white;" class="border-c" >
			<Tr>
				...
				<td width="70%" style="padding:5px;text-align:right;color:#ccc;">${response.fen2Yuan_amt}</td>
			</tr>
		</table>
		<form action="cshoprtn/drawInSubmit"  method="post" id="yzmForm">
		<table style="margin:auto;margin-top:20px; width:100%;background:white;" class="border-c" >
			<Tr>
				<td width="70%"><input class="am-form-field border-c"
					type="text" id="yzm" name="yzm" style="height: 50px;" required
	...
	<a class="am-btn am-btn-danger background-red border-c" onclick="ajaxPayIn()" style="width:100%;margin-top:15px;font-size:20px;" target="_blank">充值</a>
</body>
</html>
