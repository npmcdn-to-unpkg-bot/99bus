...
<body
	...
	<form action="usr/setTradPwd" method="post"  class="am-form" id="form-with-tooltip">
		<span>您正在设置用户${showUseName} 的交易密码</span>
		...
		<table
			...
			<Tr style="border-bottom: 1px solid #f0f1f4;">
				<td width="80%" colspan=2>
					<div class="am-form-group border-c mrgn-pdng-zero">
						<input class="am-form-field border-c" 
						required	type="password" id=tradpwd name=tradpwd 
		...
		<table
			...
			<Tr style="border-bottom: 1px solid #f0f1f4;">
				<td width="80%" colspan=2>
					<div class="am-form-group border-c mrgn-pdng-zero">
						<input class="am-form-field border-c" 
						required	type="password" id=tradpwd2 
						name=tradpwd2  data-equal-to="#tradpwd" 
						style="border: white; height: 50px;"
